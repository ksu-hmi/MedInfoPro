...
class DrugInfoApp:
    ...
    def get_drug_info(self):
        ...
        try:
            df = pd.read_excel(r"C:\Users\Carter\Documents\GitHub\MedInfoPro\Data\Medicine_description (1).xlsx")
        ...
        matching_drugs = df[df['drug_name'].str.contains(medication_wanted, case=False)]

        if matching_drugs.empty:
            messagebox.showinfo("Information", "No matching drugs found.")
        else:
            # Display drug information
            drug_info = matching_drugs.iloc[0]
