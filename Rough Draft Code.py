...
import pandas as pd
from Med_Repository import MedicationRepository
...
class MedInfoProInterface:
    def __init__(self, master):
        ...
        try:
            file_path = r"C:\Users\ksimm\OneDrive\Desktop\Medicine_description.xlsx"
            self.medication_data = pd.read_xlsx(file_path)
    ...
    def submit_info(self):
        ...
        medication_info = self.get_medication_info(medication_name)
    ...
    def get_medication_info(self, medication_name):
        ...
        try:
            return self.medication_data[self.medication_data['Correct_Column_Name'] == Drug_Name]
        except KeyError:
